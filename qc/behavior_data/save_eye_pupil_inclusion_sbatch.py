...
parser = argparse.ArgumentParser(description='running sbatch for save_eye_pupil_inclusion_df.py')  # noqa: E501
...
if __name__ == '__main__':
    ...
    python_file = python_dir / 'save_eye_pupil_inclusion_df.py'

    ####################
    # Choose job_dir for saving the job records
    job_dir = Path(r'\\allen\programs\mindscope\workgroups\learning\qc_pupil\eye_pupil_inclusion'.replace('\\', '/'))  # noqa: E501
