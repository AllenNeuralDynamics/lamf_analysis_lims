...
parser = argparse.ArgumentParser(description='running sbatch for save_pupil_movie_dlc_overlaid.py')  # noqa: E501
...
if __name__ == '__main__':
    ...
    python_file = python_dir / 'save_pupil_movie_dlc_overlaid.py'

    ####################
    # Choose job_dir for saving the job records
    job_dir = Path(r'\\allen\programs\mindscope\workgroups\learning\qc_pupil'.replace('\\', '/'))  # noqa: E501
