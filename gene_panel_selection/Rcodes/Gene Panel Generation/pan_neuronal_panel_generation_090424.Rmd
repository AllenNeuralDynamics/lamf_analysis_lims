...
supertypes <-as.data.frame(read.xlsx('/allen/programs/mindscope/workgroups/omfish/hannahs/mfish_project/gene_panels/tasic2018_supertypes_manual_v2.xlsx',paste0('all_supertypes_v2')))
...
if (layer_2_3_4_filter){ 
  ...
  cluster_layers = table(anno$layer_label[(anno$class_label %in% 'GABAergic')],anno$cluster_label[(anno$class_label %in% 'GABAergic')])
