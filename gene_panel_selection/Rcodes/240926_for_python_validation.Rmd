...
write.csv(run_genes, file = paste0(output_folder,"/run_genes.csv"), row.names = FALSE)
...
selection_results <- data.frame(Gene = built_panel, Accuracy = full_panel_correct)
...
write.csv(selection_results, file = paste0(output_folder, "/gene_panel_selection_results_nosubsample_R.csv"), row.names = FALSE)
